...
function deployAndroidBuild(apiKey, apkFileLocation, androidAppId, deployConfig) {
  var deployAndroidCurlCommand = formHockeyAppCurlCommand(apiKey, androidAppId, apkFileLocation, undefined, deployConfig);
